              ...
              return function (errorMapper) {
                  return function (peMapper) {
                      return function (response) {
                          ...
                          throw new Error("Failed pattern match at Variant line 21, column 1 - line 28, column 40: " + [ errorMapper.constructor.name, peMapper.constructor.name, response.constructor.name ]);
                      };
                  };
              };
          };
...
(function(exports) {
  ...
  var mapBasicError = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 79, column 1 - line 79, column 83: " + [ v.constructor.name ]);
  };
  ...
  var mapNotFound = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 112, column 1 - line 112, column 99: " + [ v.constructor.name ]);
  };
  ...
  var main = Control_Monad_Aff.launchAff_(Control_Bind.bind(Control_Monad_Aff.bindAff)(getFilePlus("data.json"))(function (v) {
      var str = (function () {
          if (v instanceof Data_Either.Left) {
              ...
              throw new Error("Failed pattern match at Main line 131, column 29 - line 136, column 17: " + [ v.value0.constructor.name ]);
          };
          if (v instanceof Data_Either.Right) {
              return v.value0;
          };
          throw new Error("Failed pattern match at Main line 130, column 15 - line 136, column 29: " + [ v.constructor.name ]);
      })();
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("S." + str)))(function () {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(getFilePlus$prime("data.json"))(function (v1) {
              var str$prime = (function () {
                  ...
                  throw new Error("Failed pattern match at Main line 139, column 16 - line 147, column 29: " + [ v1.constructor.name ]);
              })();
