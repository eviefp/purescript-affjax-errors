...
(function(exports) {
                  ...
                  return function (peMapper) {
                      return function (response) {
                          if (statusOk(response.status)) {
                              return Data_Bifunctor.lmap(Data_Either.bifunctorEither)(function ($12) {
                                  return Data_Variant.expand(dictUnion1)(peMapper($12));
                          ...
                          throw new Error("Failed pattern match at Variant line 24, column 1 - line 31, column 40: " + [ errorMapper.constructor.name, peMapper.constructor.name, response.constructor.name ]);
                      };
                  };
              };
          };
  ...
  var runAffjaxWithError = function (dictRequestable) {
      return function (dictDecodeJson) {
          return function (dictUnion) {
              return function (dictUnion1) {
                  return function (statusCodeMap) {
                      return function (parseErrorMap) {
                          return function (req) {
                              return Data_Functor.map(Control_Monad_Aff.functorAff)(decodeWithError(dictDecodeJson)(dictUnion)(dictUnion1)(statusCodeMap)(parseErrorMap))(Network_HTTP_Affjax.affjax(dictRequestable)(Network_HTTP_Affjax_Response.responsableString)(req));
                          };
                      };
                  };
              };
  ...
  exports["decodeWithError"] = decodeWithError;
  exports["runAffjaxWithError"] = runAffjaxWithError;
...
(function(exports) {
  ...
  var getFile = function (s) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Request.requestableUnit)(Network_HTTP_Affjax_Response.responsableString)((function () {
          var $14 = {};
          for (var $15 in Network_HTTP_Affjax.defaultRequest) {
              if ({}.hasOwnProperty.call(Network_HTTP_Affjax.defaultRequest, $15)) {
                  $14[$15] = Network_HTTP_Affjax["defaultRequest"][$15];
              };
          };
          $14.url = "simpleAPI/" + s;
          $14.method = new Data_Either.Left(Data_HTTP_Method.GET.value);
          return $14;
      })()))(function (v) {
  ...
  var someErrorMapStatusCode = new Simple.MapStatusCode(function ($43) {
      return SomeBasicError.create(Simple.mapParserError(basicErrorMapStatusCode)($43));
  }, function (v) {
      if (v === 404) {
  ...
  var getFilePlus = function (s) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Request.requestableUnit)(Network_HTTP_Affjax_Response.responsableString)((function () {
          var $19 = {};
          for (var $20 in Network_HTTP_Affjax.defaultRequest) {
              if ({}.hasOwnProperty.call(Network_HTTP_Affjax.defaultRequest, $20)) {
                  $19[$20] = Network_HTTP_Affjax["defaultRequest"][$20];
              };
          };
          $19.url = s;
          $19.method = new Data_Either.Left(Data_HTTP_Method.GET.value);
          return $19;
      })()))(function (v) {
  ...
  var mapBasicError = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 83, column 1 - line 83, column 46: " + [ v.constructor.name ]);
  };
  ...
  var getFile$prime = function (s) {
      return Variant.runAffjaxWithError(Network_HTTP_Affjax_Request.requestableUnit)(Data_Argonaut_Decode_Class.decodeJsonString)()()(mapBasicError)(Data_Function["const"](parseError))((function () {
          var $24 = {};
          ...
          $24.url = "simpleAPI/" + s;
          $24.method = new Data_Either.Left(Data_HTTP_Method.GET.value);
          return $24;
      })());
  };
  ...
  var mapNotFound = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 110, column 1 - line 110, column 43: " + [ v.constructor.name ]);
  };
  var getFilePlus$prime = function (s) {
      return Variant.runAffjaxWithError(Network_HTTP_Affjax_Request.requestableUnit)(Data_Argonaut_Decode_Class.decodeJsonString)()()(mapNotFound)(Data_Function["const"](parseError))((function () {
          var $28 = {};
          ...
          $28.url = s;
          $28.method = new Data_Either.Left(Data_HTTP_Method.GET.value);
          return $28;
      })());
  };
  var main = Control_Monad_Aff.launchAff_(Control_Bind.bind(Control_Monad_Aff.bindAff)(getFilePlus("data.json"))(function (v) {
      var str = (function () {
          if (v instanceof Data_Either.Left) {
              ...
              throw new Error("Failed pattern match at Main line 128, column 29 - line 133, column 17: " + [ v.value0.constructor.name ]);
          };
          if (v instanceof Data_Either.Right) {
              return v.value0;
          };
          throw new Error("Failed pattern match at Main line 127, column 15 - line 133, column 29: " + [ v.constructor.name ]);
      })();
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("S." + str)))(function () {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(getFilePlus$prime("data.json"))(function (v1) {
              var str$prime = (function () {
                  ...
                  throw new Error("Failed pattern match at Main line 136, column 16 - line 144, column 29: " + [ v1.constructor.name ]);
              })();
